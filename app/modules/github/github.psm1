...
function Get-GithubRepositoryLabels {
  param (
  [String]
  $owner,
  [String]
  ...
  return invoke-githubapi -Endpoint "repos/$owner/$repo/labels" -ErrorAction Stop
}

function New-GithubRepositoryLabel {
  param (
  [String]
  $Owner,
  [String]
  ...
  return invoke-githubapi -Endpoint "repos/$owner/$repo/labels" -Method POST -body $bodyJson
}

function Set-GithubRepositoryLabel {
  param (
  [String]
  $Owner,
  [String]
  ...
  return invoke-githubapi -Endpoint "repos/$owner/$repo/labels/$name" -Method PATCH -body $bodyJson -ErrorAction Stop
}

function Remove-GithubRepositoryLabel {
  param (
  [String]
  $owner,
  [String]
  ...
  return invoke-githubapi -Endpoint "repos/$owner/$repo/labels/$name" -Method DELETE -ErrorAction Stop
}
